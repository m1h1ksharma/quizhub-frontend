...
function PasscodeModal({ onClose }) {
  ...
  // Helper function to check mobile
  ...
  const handleVerify = async () => {
    ...
    try {
      // FIX: Ensure leading slash for correct API pathing
  ...
  return (
    <div style={styles.overlay}>
      <div style={{ ...styles.modal, padding: isMobile() ? "30px 20px" : "40px" }}>
        {/* Close Button */}
        ...
        <h3 style={{ ...styles.title, fontSize: isMobile() ? "18px" : "22px" }}>
...
const styles = {
  ...
  title: { fontWeight: "800", color: "#1e293b", margin: "0 0 10px 0" },
