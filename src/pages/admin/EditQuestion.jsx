...
function EditQuestion() {
  ...
  return (
    <div style={{ ...styles.pageContainer, padding: isMobile ? "15px" : "40px" }}>
      ...
      <style>{`
        .save-btn-hover:hover { transform: translateY(-3px); box-shadow: 0 10px 25px 5px rgba(37, 99, 235, 0.4); transition: 0.3s; }
        .swal-cool-toast { border-radius: 16px !important; padding: 10px 15px !important; background: rgba(255, 255, 255, 0.95) !important; backdrop-filter: blur(10px) !important; border: 1px solid #e2e8f0 !important; box-shadow: 0 10px 30px rgba(0,0,0,0.1) !important; font-family: 'Plus Jakarta Sans', sans-serif !important; }
        .swal2-title { font-size: 14px !important; font-weight: 700 !important; color: #0f172a !important; }
