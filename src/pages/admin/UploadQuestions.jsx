  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = (evt) => {
      try {
        ...
        Swal.fire({ title: 'Format Error', text: 'Invalid Excel structure.', icon: 'error' });
      }
    };
          ...
          {activeTab === "excel" && (
            <div style={{ animation: 'fadeIn 0.4s ease' }}>
              <div style={styles.formatInfo}>
                <div style={styles.formatHeader}><FaInfoCircle color="#059669" /><span style={{ fontWeight: '800', color: '#065f46' }}> Expected Excel Structure</span></div>
