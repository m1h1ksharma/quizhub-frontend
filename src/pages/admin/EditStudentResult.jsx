            ...
            <div style={{ ...styles.card, padding: isMobile ? "25px 20px" : "40px" }}>
                ...
                <form onSubmit={handleUpdate} style={styles.form}>
                    <div style={styles.inputGroup}>
                        ...
                        <input name="studentName" value={formData.studentName} onChange={handleChange} required style={styles.input} />
                    </div>

                    <div style={styles.inputGroup}>
                        <label style={styles.label}>Mobile Number</label>
                        <input name="studentMobile" value={formData.studentMobile} onChange={handleChange} required style={styles.input} />
                    </div>

                    {/* Dynamic Grid: Mobile par 1 column, Desktop par 2 */}
                    <div style={{ 
                        ...styles.grid, 
                        ...
                        <div style={styles.inputGroup}>
                            ...
                            <input type="number" name="score" value={formData.score} onChange={handleChange} required style={styles.input} />
                        </div>
                        <div style={styles.inputGroup}>
                            <label style={styles.label}>Total Questions</label>
                            <input type="number" name="totalQuestions" value={formData.totalQuestions} onChange={handleChange} required style={styles.input} />
                        </div>
                    </div>

                    <div style={styles.inputGroup}>
                        <label style={styles.label}>Quiz Round</label>
                        <input name="quizRound" value={formData.quizRound} onChange={handleChange} required style={styles.input} />
                    </div>
