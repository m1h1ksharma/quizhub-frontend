...
function QuizSettings() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      setSettings((prev) => ({ ...prev, ...timerRes.data }));
  ...
  const handleGoLive = async () => {
    try {
      ...
      window.dispatchEvent(new Event("roundUpdated")); // Sidebar Sync
      Swal.fire({
        ...premiumAlert,
        title: 'System Live!',
    ...
    <div style={{ ...styles.page, padding: isMobile ? "16px" : "40px" }}>
      ...
      <div style={{ ...styles.cardGrid, gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fill, minmax(340px, 1fr))" }}>
        {rounds.map((round, index) => {
          ...
          return (
            <div key={index} className="elite-card" style={{
              ...styles.roundCard, border: isActive ? "2.5px solid #2563eb" : "1px solid #f1f5f9"
            }}>
        ...
        <div style={styles.overlay}>
          <div className="modal-pop" style={{ ...styles.modal, width: isMobile ? "95%" : "750px" }}>
            ...
            <div style={styles.modalFooter}>
              ...
              <button onClick={handleGoLive} style={styles.liveBtn}><FaRocket /> Launch Round</button>
            </div>
          </div>
        </div>
      )}
      ...
      <style>{`
        ...
        .swal-ultra-popup { border-radius: 32px !important; padding: 2.5rem !important; background: #fff !important; border: 1px solid #f1f5f9 !important; box-shadow: 0 25px 60px rgba(0,0,0,0.1) !important; }
        .swal-ultra-title { color: #0f172a !important; font-weight: 900 !important; font-size: 24px !important; }
        .swal-ultra-confirm { background: #0f172a !important; color: #fff !important; border-radius: 14px !important; padding: 14px 32px !important; font-weight: 700 !important; border: none !important; cursor: pointer; margin-left: 10px !important; }
        .swal-ultra-cancel { background: #f1f5f9 !important; color: #64748b !important; border-radius: 14px !important; padding: 14px 32px !important; font-weight: 700 !important; border: none !important; cursor: pointer; }
        .swal-premium-toast { border-radius: 20px !important; padding: 12px 20px !important; background: rgba(255, 255, 255, 0.98) !important; backdrop-filter: blur(10px) !important; border: 1px solid #e2e8f0 !important; box-shadow: 0 10px 30px rgba(0,0,0,0.05) !important; }
...
const styles = {
  ...
  roundCard: { background: "#fff", borderRadius: "35px", padding: "30px", boxShadow: "0 10px 25px rgba(0,0,0,0.02)" },
  ...
  deleteBtn: { border: "none", background: "#f8fafc", color: "#cbd5e1", width: "42px", height: "42px", borderRadius: "14px", cursor: "pointer" },
  ...
  manageBtn: { marginTop: "25px", width: "100%", border: "none", background: "#0f172a", color: "#fff", padding: "18px", borderRadius: "18px", cursor: "pointer", fontWeight: "800", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", transition: '0.3s' },
