...
import {
  FaSearch, FaUndo, FaSync, FaFilter, FaUserGraduate, FaPhoneAlt,
  FaFlag
} from "react-icons/fa";
  ...
  return (
    <div style={styles.container}>
      ...
      <style>{`
        ...
        .swal-premium-cancel { background: #f1f5f9 !important; color: #64748b !important; border-radius: 14px !important; padding: 14px 28px !important; font-weight: 700 !important; border: none !important; cursor: pointer; }
        .swal-toast-popup { border-radius: 15px !important; padding: 12px 20px !important; background: rgba(255, 255, 255, 0.95) !important; backdrop-filter: blur(10px) !important; border: 1px solid #e2e8f0 !important; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.05) !important; }
